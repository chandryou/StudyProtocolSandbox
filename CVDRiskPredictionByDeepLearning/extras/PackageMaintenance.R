...
OhdsiRTools::checkUsagePackage("CVDRiskPredictionByDeepLearning")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CVDRiskPredictionByDeepLearning.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CVDRiskPredictionByDeepLearning.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "CVDRiskPredictionByDeepLearning")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CVDRiskPredictionByDeepLearning")
