...
Please copy the `CVDRiskPredictionByDeepLearning` folder. Choose a name for your study package, and change all references from 'CVDRiskPredictionByDeepLearning' to your name of choice in the package code. 
