...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4319328,4326561,372924,4218781,376713,4110189,443454,4111714,4108356,4110190,4110192,381316,4176892,4045734,4110185,436430,4111709,4226021,432923,4108952,4111708,4049659,373503,374384,4164092)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4319328,4326561,372924,4218781,376713,4110189,443454,4111714,4108356,4110190,4110192,381316,4176892,4045734,4110185,436430,4111709,4226021,432923,4108952,4111708,4049659,373503,374384,4164092)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (2001510,4305852,4006788)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (319844,312327,434376,438170,444406,316427,438168,321318,438172,435561,315286,317576,4127089,4108215,4110961,4108678,314666,4119953,319038,315296,4108679,4108219,4108220,4124683,4108217,4108677,4108218,4108680)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (438170,444406,316427,438168,321318,438172,435561,315286,317576,4127089,4108215,4110961,4108678,314666,4119953,319038,315296,4108679,4108219,4108220,4124683,4108217,4108677,4108218,4108680)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (320128)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
WHERE YEAR(C.condition_start_date) - P.year_of_birth >= 40
...
) A on A.person_id = P.person_id and A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,-1095,P.START_DATE) and A.START_DATE <= DATEADD(day,-1,P.START_DATE)
GROUP BY p.person_id, p.event_id
